...
function DairyItem({ dairy }) {
  const [editing, setEditing] = useState(false)
   const [id, setId] = useState(dairy.id)
  const [name, setName] = useState(dairy.name)
  const [description, setDescription] = useState(dairy.description)
  const [imageUrl, setImageUrl] = useState(dairy.imageUrl)
  const [markdown, setMarkDown] = useState(dairy.markdown)
  const [showDetails, setShowDetails] = useState(false)
  const [status, setStatus] = useState(dairy.status)
